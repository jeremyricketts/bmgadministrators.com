...
<?php $thisPage="HMO Dental Insurance Application"; ?>
...
<script type="text/javascript" src="validation/dental-ap2.js"></script>
</head>
<body>
...
<div id="wrapper-subnav">
	<div id="subnav">
		<ul id="subnav">
			...
			<li><a href="https://bmgadministrators.com/dental-ap2.php" id="subnavDentApply2" class="current">PPO Dental Application</a></li>
		</ul>
	</div><!-- /subnav -->
</div><!-- /wrapper-subnav -->
...
<div id="application">
<h2>HMO Dental Insurance Application</h2>
...
<!-- Form Action  -->
<form name="dentalap2" action="email_scripts/_dentalap2.php" method="post" id="dentalap2">
<!-- /Form Action  -->
<fieldset>
...
<fieldset>
	<legend>Dentist Choice</legend>
<div id="dentists">
	<p><em>* You must select a dentist within the HMO Network. All services must be coordinated through the selected provider.</em></p>
	<p><a href="http://assurant.go2dental.com/member/dental_search/srchinp.cgi?plan_number=27" rel="external">Please choose a dentist</a> <span id="help_bug" title="header=[<img src='images/information.png' style='vertical-align:middle'>&nbsp;&nbsp;Choosing a Dentist:] body=[This link opens a new page where you can search for a dentist within the HMO network.<br /><br />We need you to pick a dentist now to get you enrolled but YES you can change your dentist later. For more information, please check out the FAQ at the bottom of the Product Information page.] cssbody=[tip_body] cssheader=[tip_header]"><img src="images/help.png" alt="" border="none" /></span></p>
	<p><label for="dentist_id">Dentist Choice</label><span id="help_bug" title="header=[<img src='images/information.png' style='vertical-align:middle'>&nbsp;&nbsp;Dentist ID Number:] body=[This the <b>seven digit ID code</b> for the dentist you wish to use.  Use the above link to search for a dentist from the provider's web site and then put that dentist's ID Number here.] cssbody=[tip_body] cssheader=[tip_header]"><img src="images/help.png" alt="" border="none" /></span><br /><input name="dentist_id" type="text" id="dentist_id"/> (example: "#0016382" )</p>
</div><!-- /dentist -->
</fieldset>
