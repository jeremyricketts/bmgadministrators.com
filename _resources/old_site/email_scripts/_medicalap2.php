...
$valid_ref1="https://bmgadministrators.com/medical-ap2.php";// change "Your--domain" to your domain
$valid_ref2="https://www.bmgadministrators.com/medical-ap2.php";// change "Your--domain" to your domain
...
$replymessage = "Dear $firstname,
    ...
    This is a confirmation email from The Benefits Management Group. You have submitted an \"Online Quote Request for Medical Insurance for Individuals and Families\". A copy of the information you submitted is included below. One of our representatives will be contacting you soon to further assist you.
...
POLICY DEPENDENTS:
(The spouse or family members who will be covered by this medical policy...)
...
mail("$replyemail",
     "KaiserMedicalInsurance.com: Medical Insurance Quote Request - Individuals/Families",
     "$finalmessage",
     "From: $email\nReply-To: $email");
mail("$email",
