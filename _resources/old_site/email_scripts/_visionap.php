...
$valid_ref1="https://bmgadministrators.com/vision-ap.php";// change "Your--domain" to your domain
$valid_ref2="https://www.bmgadministrators.com/vision-ap.php";// change "Your--domain" to your domain
...
APPLICATION DETAILS:
	...
	Insurance Type:  Vision Insurance
	Applying For:  $applying_for
	Requested Effective Date:  $effective_month/01/$effective_year


POLICY DEPENDENTS:
(The spouse or family members who will be covered by this Vision policy...)
...
$finalmessage = "An Online Application has been recieved: Vision Insurance (individuals/families).  This Online Application came from your web site: (more specifically: $ref_page)
...
mail("$replyemail",
     "KaiserMedicalInsurance.com: Vision Insurance Online Application - Individuals/Families",
     "$finalmessage",
     "From: $email\nReply-To: $email");
mail("$email",
