...
$valid_ref1="https://bmgadministrators.com/dental-ap1.php";// change "Your--domain" to your domain
$valid_ref2="https://www.bmgadministrators.com/dental-ap1.php";// change "Your--domain" to your domain
...
APPLICATION DETAILS:
	...
	Insurance Type:  PPO Dental
	Applying For:  $applying_for
	Requested Effective Date:  $effective_month/01/$effective_year


POLICY DEPENDENTS:
(The spouse or family members who will be covered by this PPO dental policy...)
...
mail("$replyemail",
     "KaiserMedicalInsurance.com: PPO Dental Insurance Online Application - Individuals/Families",
     "$finalmessage",
     "From: $email\nReply-To: $email");
mail("$email",
