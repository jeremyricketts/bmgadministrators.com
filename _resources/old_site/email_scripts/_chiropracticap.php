...
$valid_ref1="https://bmgadministrators.com/chiropractic-ap.php";// change "Your--domain" to your domain
$valid_ref2="https://www.bmgadministrators.com/chiropractic-ap.php";// change "Your--domain" to your domain
...
======== Chiropractic Insurance for Individuals and Families =========
...
APPLICATION DETAILS:
	...
	Insurance Type:  Chiropractic Insurance
	Applying For:  $applying_for
	Requested Effective Date:  $effective_month/01/$effective_year
	

POLICY DEPENDENTS:
(The spouse or family members who will be covered by this Chiropractic policy...)
...
mail("$replyemail",
     "KaiserMedicalInsurance.com: Chiropractic Insurance Online Application - Individuals/Families",
     "$finalmessage",
     "From: $email\nReply-To: $email");
mail("$email",
