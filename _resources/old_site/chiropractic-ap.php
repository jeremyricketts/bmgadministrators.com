...
<?php $thisPage="Chiropractic Insurance Application"; ?>
...
<script type="text/javascript" src="validation/chiropractic-ap.js"></script>
</head>
<body>
...
<h1><a href="https://bmgadministrators.com/" title="home"><img src="images/logo.gif" alt="Benefits Management Group" /></a></h1>
	<ul id="nav">
		...
		<li><a href="https://bmgadministrators.com/chiropractic.php" id="navChiropractic" class="current">Chiropractic</a></li>
	</ul>
</div><!-- /mast  -->

</div><!-- /wrapper-top -->

<div id="banner" class="banner-chiropractic-ap"><!-- /SPECIFIC TO THIS PAGE -->
</div><!-- banner  -->

<div id="wrapper-subnav">
	<div id="subnav">
		<ul id="subnav">
			<li><a href="https://bmgadministrators.com/chiropractic.php" id="subnavPi">Medical Insurance Information</a></li>
			<li><a href="https://bmgadministrators.com/chiropractic-ap.php" id="subnavApply" class="current">Chiropractic Insurance Application</a></li>
		</ul>
	</div><!-- /subnav -->
</div><!-- /wrapper-subnav -->
...
<div id="application">
<h2>Chiropractic Insurance Application</h2>
...
<!-- Form Action  -->
<form name="chiropracticap" action="email_scripts/_chiropracticap.php" method="post" id="chiropracticap">
<!-- /Form Action  -->
<fieldset>
