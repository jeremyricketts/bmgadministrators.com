...
<?php $thisPage="Medical Insurance Quote Request | for individuals and families"; ?>
...
<script type="text/javascript" src="validation/medical-ap2.js"></script>
</head>
<body>
...
<div id="wrapper-subnav">
	<div id="subnav">
		<ul id="subnav">
			...
			<li><a href="https://bmgadministrators.com/medical-ap1.php" id="subnavMedApply1">Business / Group Application</a></li>
			<li><a href="https://bmgadministrators.com/medical-ap2.php" id="subnavMedApply2" class="current">Individual / Family Application</a></li>
		</ul>
	</div><!-- /subnav -->
</div><!-- /wrapper-subnav -->
...
<!-- Form Action  -->
<form name="medicalap2" action="email_scripts/_medicalap2.php" method="post" id="medicalap2">
<!-- /Form Action  -->
<fieldset>
...
<fieldset>
  ...
  <tr>
    ...
    <td></td>
	<td width="50px"></td>
    <td style="padding-bottom:15px;"><strong>Effective Date:</strong><span id="help_bug" title="header=[<img src='images/information.png' style='vertical-align:middle'>&nbsp;&nbsp;Effective Date:] body=[This is the date that you are requesting that your coverage become effective. Actual effective dates are determined by carrier.] cssbody=[tip_body] cssheader=[tip_header]"><img src="images/help.png" alt="" width="16" height="16" border="none" /></span></td>
  </tr>
  <tr>
...
<p><small>* For your convenience, quote requests with more than 10 <br />dependents may email or fax us a list at (951) 787-9273 </small></p>
</fieldset>
