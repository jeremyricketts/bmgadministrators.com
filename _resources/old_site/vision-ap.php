...
<?php $thisPage="Vision Insurance Application"; ?>
...
<script type="text/javascript" src="validation/vision-ap.js"></script>
</head>
<body>
...
<h1><a href="https://bmgadministrators.com/" title="home"><img src="images/logo.gif" alt="Benefits Management Group" /></a></h1>
	<ul id="nav">
		...
		<li><a href="https://bmgadministrators.com/vision.php" id="navVision" class="current">Vision</a></li>
...
<div id="banner" class="banner-vision-ap"><!-- /SPECIFIC TO THIS PAGE -->
</div><!-- banner  -->

<div id="wrapper-subnav">
	<div id="subnav">
		<ul id="subnav">
			<li><a href="https://bmgadministrators.com/vision.php" id="subnavPi">Vision Insurance Information</a></li>
			<li><a href="https://bmgadministrators.com/vision-ap.php" id="subnavApply" class="current">Vision Insurance Application</a></li>
		</ul>
	</div><!-- /subnav -->
</div><!-- /wrapper-subnav -->
...
<div id="application">
<h2>Vision Insurance Application</h2>
...
<!-- Form Action  -->
<form name="visionap" action="email_scripts/_visionap.php" method="post" id="visionap">
<!-- /Form Action  -->
<fieldset>
...
<table border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<tr>
		...
		<td><label for="state"><small>(ext)</small></label><br /><input name="ext" type="text" id="ext" size="4"/></td>
