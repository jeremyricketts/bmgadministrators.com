...
if(valid && (document.medicalap2.sex[0].checked == false) && (document.medicalap2.sex[1].checked == false))
	{
...
if(valid && ((document.medicalap2.applying_for[0].checked == false) && (document.medicalap2.applying_for[1].checked == false) && (document.medicalap2.applying_for[2].checked == false) && (document.medicalap2.applying_for[3].checked == false)))
	{
...
if(valid && (document.medicalap2.applying_for[0].checked == true) && (!isBlank(document.getElementById('dependent1_name').value)))
	{
...
if(valid && (document.medicalap2.applying_for[1].checked == true) && (isBlank(document.getElementById('dependent1_name').value)))
	{
...
if(valid && (document.medicalap2.applying_for[2].checked == true) && (isBlank(document.getElementById('dependent1_name').value)))
	{
...
if(valid && (document.medicalap2.applying_for[3].checked == true) && (isBlank(document.getElementById('dependent1_name').value)))
	{
...
if(valid && (!isBlank(document.getElementById('dependent1_name').value)) && (((document.medicalap2.dependent1_sex[0].checked == false) && (document.medicalap2.dependent1_sex[1].checked == false)) || (isBlank(document.getElementById('dependent1_relationship').value)) || (isBlank(document.getElementById('dependent1_bday_month').value)) || (isBlank(document.getElementById('dependent1_bday_day').value)) || (isBlank(document.getElementById('dependent1_bday_year').value))  || (!isNumeric(document.getElementById('dependent1_bday_month').value)) || (!isNumeric(document.getElementById('dependent1_bday_day').value)) || (!isNumeric(document.getElementById('dependent1_bday_year').value))))
	{
...
if(valid && (!isBlank(document.getElementById('dependent3_name').value)) && (((document.medicalap2.dependent3_sex[0].checked == false) && (document.medicalap2.dependent3_sex[1].checked == false)) || (isBlank(document.getElementById('dependent3_relationship').value)) || (isBlank(document.getElementById('dependent3_bday_month').value)) || (isBlank(document.getElementById('dependent3_bday_day').value)) || (isBlank(document.getElementById('dependent3_bday_year').value))  || (!isNumeric(document.getElementById('dependent3_bday_month').value)) || (!isNumeric(document.getElementById('dependent3_bday_day').value)) || (!isNumeric(document.getElementById('dependent3_bday_year').value))))
	{
		message = '<p><strong>Error:</strong></p><p>One of the <strong>dependents</strong> you listed is <strong>missing</strong> some information.<br /><strong>Birthdays</strong> can only contain numbers.</p><p><b>Note:</b><br />If you are only applying for yourself and have no dependents, please delete the names of the dependents you entered.</p>';
		window.scrollTo(0,0)
		tbl = document.getElementById("dependents");
...
if(valid && (!isBlank(document.getElementById('dependent4_name').value)) && (((document.medicalap2.dependent4_sex[0].checked == false) && (document.medicalap2.dependent4_sex[1].checked == false)) || (isBlank(document.getElementById('dependent4_relationship').value)) || (isBlank(document.getElementById('dependent4_bday_month').value)) || (isBlank(document.getElementById('dependent4_bday_day').value)) || (isBlank(document.getElementById('dependent4_bday_year').value))  || (!isNumeric(document.getElementById('dependent4_bday_month').value)) || (!isNumeric(document.getElementById('dependent4_bday_day').value)) || (!isNumeric(document.getElementById('dependent4_bday_year').value))))
	{
		message = '<p><strong>Error:</strong></p><p>One of the <strong>dependents</strong> you listed is <strong>missing</strong> some information.<br /><strong>Birthdays</strong> can only contain numbers.</p><p><b>Note:</b><br />If you are only applying for yourself and have no dependents, please delete the names of the dependents you entered.</p>';
		window.scrollTo(0,0)
		tbl = document.getElementById("dependents");
...
if(valid && (!isBlank(document.getElementById('dependent8_name').value)) && (((document.medicalap2.dependent8_sex[0].checked == false) && (document.medicalap2.dependent8_sex[1].checked == false)) || (isBlank(document.getElementById('dependent8_relationship').value)) || (isBlank(document.getElementById('dependent8_bday_month').value)) || (isBlank(document.getElementById('dependent8_bday_day').value)) || (isBlank(document.getElementById('dependent8_bday_year').value))  || (!isNumeric(document.getElementById('dependent8_bday_month').value)) || (!isNumeric(document.getElementById('dependent8_bday_day').value)) || (!isNumeric(document.getElementById('dependent8_bday_year').value))))
	{
		message = '<p><strong>Error:</strong></p><p>One of the <strong>dependents</strong> you listed is <strong>missing</strong> some information.<br /><strong>Birthdays</strong> can only contain numbers.</p><p><b>Note:</b><br />If you are only applying for yourself and have no dependents, please delete the names of the dependents you entered.</p>';
		window.scrollTo(0,0)
		tbl = document.getElementById("dependents");
